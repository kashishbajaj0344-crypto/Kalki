...
logger = logging.getLogger('Kalki.Memory')
...
class MemoryEntry:
    ...
    def __post_init__(self):
        """Standardize metadata keys after initialization."""
        self._standardize_metadata()
    
    def _standardize_metadata(self):
        """Ensure metadata follows standard structure."""
        defaults = {
            "type": "system",
            "source": "unknown",
            "phase": 0,
...
# [Kalki v2.3 — memory/base.py v1.0]