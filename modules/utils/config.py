...
CONFIG: Dict[str, Any] = {
    ...
    # Model Configuration
    "DEFAULT_LLM_MODEL": _get_env("DEFAULT_LLM_MODEL", "meta-llama/Llama-3.1-8B-Instruct"),
    "EMBEDDING_MODEL": _get_env("EMBEDDING_MODEL", "BAAI/bge-large-en-v1.5"),

    # System Limits
    "MAX_TOKENS": int(_get_env("MAX_TOKENS", "4096")),
    "MAX_CONTEXT_LENGTH": int(_get_env("MAX_CONTEXT_LENGTH", "32768")),
